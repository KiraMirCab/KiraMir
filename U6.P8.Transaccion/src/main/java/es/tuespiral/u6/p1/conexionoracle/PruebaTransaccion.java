...
import es.tuespiral.u6.p1.conexionoracle.dominio.Carrito;
import es.tuespiral.u6.p1.conexionoracle.excepciones.OrderException;
import es.tuespiral.u6.p1.conexionoracle.dominio.OrderItem;
        ...
        if (!carro.isEmpty()) {
            ...
            if (respuesta.equalsIgnoreCase("S")
                ...
                try {
                    ...
                    System.out.println("La transacción finalizó con errores y se revertieron los cambios");
                }
            } else {
